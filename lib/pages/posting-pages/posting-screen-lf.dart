...
class LostFoundPostingScreen extends StatefulWidget {
  @override
  _LostFoundPostingScreenState createState() => _LostFoundPostingScreenState();
}

class _LostFoundPostingScreenState extends State<LostFoundPostingScreen> {
  ...
  uploadPost() async {
    if (imageFile != null) {
      ...
      Map<String,String> postMap ={
        ...
        "when": when,
        "where": where,
        "tagName": "L&F", // get from fab click
