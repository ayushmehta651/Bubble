                  ...
                  child: AbsorbPointer(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16,),
                        PollButton(label: widget.post.option1Text,percentage: widget.per1,btnIcon: Icons.looks_one_outlined, onClick: (){changeState();},),
                        SizedBox(height: 8,),

                        PollButton(label: widget.post.option2Text,percentage: widget.per2,btnIcon: Icons.looks_two_outlined, onClick: (){changeState();},),
                        SizedBox(height: 8,),

                        PollButton(label: widget.post.option3Text,percentage: widget.per3,btnIcon: Icons.looks_3_outlined,onClick: (){changeState();},),
                        SizedBox(height: 8,),

                        PollButton(label: widget.post.option4Text,percentage: widget.per4,btnIcon: Icons.looks_4_outlined,onClick: (){changeState();},),
                        SizedBox(height: 8,),
